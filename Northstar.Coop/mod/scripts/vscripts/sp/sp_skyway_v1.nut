...
void function PlayerTortureRoomSequence( entity scriptRef, entity player, string firstPersonAnim = "pov_torture_intro_player", string thirdPersonAnim = "pt_torture_intro_player" )
{
	...
	if ( !Flag( "TorturePlayerResponded" ) )
  	{
		...
		waitthread FirstPersonSequence( sequenceTortureRoom, GetProtagonist(), moverIntro )
	...
	{
		if ( player != GetProtagonist() )
			thread FirstPersonSequence( sequenceTortureRoomDrag, GetProtagonist(), moverIntro )
	}
	...
	waitthread FirstPersonSequence( sequenceTortureRoomKill, GetProtagonist(), moverIntro )
	...
	waitthread FirstPersonSequence( sequenceTortureRoomGetup, GetProtagonist(), moverIntro )
...
void function BTSacrificeStartPointSetup( entity player )
{
	...
	thread BTSacrificeDialogue_BTMemory( GetProtagonist() )
