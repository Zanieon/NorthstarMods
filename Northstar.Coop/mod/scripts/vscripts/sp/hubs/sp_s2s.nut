...
global function ReplaceProtagonist
...
void function ReplaceProtagonist()
{
...
void function ViperDead_Main( entity player )
{
	...
	if ( !IsValid(bt) )
		bt = CreatePetTitanAtOrigin( GetProtagonist(), file.respawnWidow.mover.GetOrigin() + <0,0,300>, <0,0,0> )
